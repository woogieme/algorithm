<%@ page language="java" contentType="text/html; charset=UTF-8" 
	...
	<%-- <c:set var="memberDto" value="${}"></c:set> --%>
	<c:if test="${ cookie.ssafy_id.value ne null}"></c:if>
...
<c:if test="${not useInfo}">
    <div class="container">
		<!-- 로그인 사용자 정보(로그아웃) 출력 -->
		<%= memberDto.getUserName()  %> (<%=memberDto.getUserId() %>) 님 안녕하세요.
