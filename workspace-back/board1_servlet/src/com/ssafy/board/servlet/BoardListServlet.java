...
//		2. 1에서 얻어온 List의 갯수만큼 <tr>을 이용하여 출력하세요.
		...
		out.println("              <button onclick='write.html' type=\"button\" id=\"btn-mv-register\" class=\"btn btn-outline-primary btn-sm\">");
		out.println("                글쓰기");
		out.println("              </button>");
		out.println("            </div>");
		...
		for(BoardDto value :list) {
			out.println("              <tr class=\"text-center\">");
			out.println("                <th scope=\"row\">93</th>");
			out.println("                <td class=\"text-start\">");
			out.println("                  <a");
			out.println("                    href='view?articleNo="+value.getArticleNo()+"'");
			out.println("                    class=\"article-title link-dark\"");
			out.println("                    data-no="+value.getArticleNo()+"");
			out.println("                    style=\"text-decoration: none\"");
			out.println("                  >");
			out.println(value.getContent());
			out.println("                  </a>");
			out.println("                </td>");
			out.println("                <td>"+value.getUserId()+"</td>");
			out.println("                <td>"+value.getHit()+"</td>");
			out.println("                <td>"+value.getRegisterTime()+"</td>");
			out.println("              </tr>");
		}
		out.println("            </tbody>");
		out.println("          </table>");
